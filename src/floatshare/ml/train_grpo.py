"""GRPO 训练 CLI — Phase 1/2, critic-free + group-relative baseline.
...
def main() -> None:
    ...
    p.add_argument("--pretrained", default=None, help="加载 backbone ckpt 路径 (如 PPO/POP best)")
    ...
    trainer = GRPOTrainer(model_cfg, data_cfg, grpo_cfg, train_cfg, epochs=args.epochs)
    trainer.fit()
